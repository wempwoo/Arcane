...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArcaneBackend.Core.Entities.ExplorationNode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ExplorationMapId")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("ExplorationNodes");
                });

            modelBuilder.Entity("ArcaneBackend.Core.Entities.ExplorationPathway", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ArcaneBackend.Core.Entities.ExplorationPathway", b =>
                {
                    b.HasOne("ArcaneBackend.Core.Entities.ExplorationNode", "FromNode")
                        .WithMany("OutgoingPaths")
                        .HasForeignKey("FromNodeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ArcaneBackend.Core.Entities.ExplorationNode", "ToNode")
                        .WithMany("IncomingPaths")
            ...
            modelBuilder.Entity("ArcaneBackend.Core.Entities.ExplorationNode", b =>
                {
                    b.Navigation("IncomingPaths");

                    b.Navigation("OutgoingPaths");
                });
